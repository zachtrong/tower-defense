...
//              // bossplay.setBottom(bossplay.getBottom()+0);
//            }
//            if (monster2.getLeft() >= 570
//                && monster2.getTop() >= 40
//                && monster2.getLeft() <= 1500) {
//
...
//            }
//            if (monster2.getLeft() <= 1510
//                && monster2.getTop() <= 40
//                && monster2.getLeft() >= 570) {
//              monster2.setLeft(monster2.getLeft() + step);
//              // bossplay.setTop(bossplay.getTop()+0);
//              monster2.setRight(monster2.getRight() + step);
//              // bossplay.setBottom(bossplay.getBottom()+0);
...
//              // bossplay.setBottom(bossplay.getBottom()+0);
//            }
//            if (monster3.getLeft() >= 570
//                && monster3.getTop() >= 40
//                && monster3.getLeft() <= 1500) {
//
...
//            }
//            if (monster3.getLeft() <= 1510
//                && monster3.getTop() <= 40
//                && monster3.getLeft() >= 570) {
//              monster3.setLeft(monster3.getLeft() + step);
//              // bossplay.setTop(bossplay.getTop()+0);
//              monster3.setRight(monster3.getRight() + step);
//              // bossplay.setBottom(bossplay.getBottom()+0);
...
//              // bossplay.setBottom(bossplay.getBottom()+0);
//            }
//            if (monster4.getLeft() >= 570
//                && monster4.getTop() >= 40
//                && monster4.getLeft() <= 1500) {
//
...
//            }
//            if (monster4.getLeft() <= 1510
//                && monster4.getTop() <= 40
//                && monster4.getLeft() >= 570) {
//              monster4.setLeft(monster4.getLeft() + step);
//              // bossplay.setTop(bossplay.getTop()+0);
//              monster4.setRight(monster4.getRight() + step);
//              // bossplay.setBottom(bossplay.getBottom()+0);
